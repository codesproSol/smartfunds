...
!(function (t, e) {
                ...
                return function n(o) {
                  for (
                    ...
                    for (var a = s.length; a--; )
                      if (s[a] === r)
                        return (
                          (o.delegateTarget = r), n.oneOff && $.off(t, o.type, i), i.apply(r, [o])
                        );
                  return null;
                };
              })(t, i, n)
    ...
    X = (function (t) {
      ...
      return (
        ...
        (s._slide = function (t, e) {
          ...
          if (
            ("next" === t
              ? ((i = "carousel-item-start"), (n = "carousel-item-next"), (o = "left"))
              : ((i = "carousel-item-end"), (n = "carousel-item-prev"), (o = "right")),
    ...
    tt = (function (t) {
      ...
      return (
        ...
        (o.collapseInterface = function (t, e) {
          ...
          if (
            (!n && s.toggle && "string" == typeof e && /show|hide/.test(e) && (s.toggle = !1),
            n || (n = new o(t, s)),
            "string" == typeof e)
          ) {
  ...
  function At(t) {
    ...
    if (l) {
      var v = kt(i);
      v === dt(i) && (v = _t(i)),
        o === et && ((m = it), (u -= v.clientHeight - n.height), (u *= a ? 1 : -1)),
        o === ot && ((f = nt), (d -= v.clientWidth - n.width), (d *= a ? 1 : -1));
    }
    var y,
    ...
    return a
      ...
      : Object.assign(
          Object.assign({}, _),
          {},
          (((e = {})[m] = p ? u + "px" : ""), (e[f] = h ? d + "px" : ""), (e.transform = ""), e),
        );
  }
  var It = {
      name: "computeStyles",
                ...
                "auto" === ft(i)
                  ? (function (t, e) {
                      ...
                      var p = h.reduce(function (e, i) {
                        return (
                          (e[i] = Yt(t, { placement: i, boundary: o, rootBoundary: s, padding: r })[
                            ft(i)
                          ]),
                          e
                        );
    ...
    Jt = {
      ...
      fn: function (t) {
        var e = t.state,
          ...
          x =
            "function" == typeof m
              ? m(Object.assign(Object.assign({}, e.rects), {}, { placement: e.placement }))
              : m,
          C = { x: 0, y: 0 };
        if (k) {
          if (s) {
        ...
        (("body" !== ct(e) || Nt(s)) &&
          (l =
            (n = e) !== dt(n) && ht(n)
              ...
              : Ht(n)),
        ht(e) ? (((c = $t(e)).x += e.clientLeft), (c.y += e.clientTop)) : s && (c.x = Wt(s))),
      {
                ...
                for (var n = 0; n < a.orderedModifiers.length; n++)
                  if (!0 !== a.reset) {
                    var o = a.orderedModifiers[n],
                      ...
                      u = o.name;
                    "function" == typeof s &&
                      (a = s({ state: a, options: l, name: u, instance: d }) || a);
                  } else (a.reset = !1), (n = -1);
              }
            }
          },
  ...
  var oe = ne(),
    ...
    ye = (function (t) {
      ...
      return (
        ...
        (s._getConfig = function (t) {
          return (
            (t = i({}, this.constructor.Default, q.getDataAttributes(this._element), t)),
      ...
      return (
        ...
        (s.toggle = function (t) {
          if (this._isEnabled)
            if (t) {
              ...
              i ||
                ((i = new this.constructor(t.delegateTarget, this._getDelegateConfig())),
            ...
            return "object" == typeof e && h(e)
              ...
              : void (this.config.html
                  ? (this.config.sanitize &&
                      (e = xe(e, this.config.allowList, this.config.sanitizeFn)),
                    (t.innerHTML = e))
                  : (t.textContent = e));
        }),
        (s.getTitle = function () {
        ...
        (s._setListeners = function () {
          ...
          this.config.trigger.split(" ").forEach(function (e) {
            ...
            this.config.selector
              ? (this.config = i({}, this.config, { trigger: "manual", selector: "" }))
              : this._fixTitle();
        }),
        ...
        (s._getConfig = function (t) {
          ...
          return (
            ...
            "number" ==
              typeof (t = i({}, this.constructor.Default, e, "object" == typeof t && t ? t : {}))
  ...
  var Ne = "scrollspy",
    ...
    Re = (function (t) {
      ...
      return (
        ...
        (s._getConfig = function (t) {
          if (
            "string" != typeof (t = i({}, Be, "object" == typeof t && t ? t : {})).target &&
            h(t.target)
          ) {
            var e = t.target.id;
    ...
    return (
      (o.show = function () {
        ...
        if (
          ...
          var s = null;
          if (
            (e && (s = $.trigger(e, "hide.bs.tab", { relatedTarget: this._element })),
            !(
              $.trigger(this._element, "show.bs.tab", { relatedTarget: e }).defaultPrevented ||
  ...
  var Ue = { animation: "boolean", autohide: "boolean", delay: "number" },
    ...
    Ve = (function (t) {
      ...
      return (
        ...
        (s._getConfig = function (t) {
          return (
            (t = i({}, Ye, q.getDataAttributes(this._element), "object" == typeof t && t ? t : {})),
  ...
  (function (t) {
    ...
    (e.prototype = {
      ...
      initWidget: function () {
        this.canvas ||
          (this.canvas = t("<canvas>")["prepend" == this.insertMode ? "prependTo" : "appendTo"](
            this.el,
          )[0]);
        var e = this.canvas;
        if (
      ...
      initFill: function () {
        ...
        n.image &&
          (n.image instanceof Image ? (e = n.image) : ((e = new Image()).src = n.image),
        ...
        option: function (e, i) {
          ...
          if ("string" == typeof e)
            if (((r = {}), (e = (n = e.split(".")).shift()), n.length)) {
              for (o = r[e] = t.widget.extend({}, this.options[e]), s = 0; s < n.length - 1; s++)
                (o[n[s]] = o[n[s]] || {}), (o = o[n[s]]);
    ...
    t(document).on("mouseup", function () {
      ...
      t.widget("ui.slider", t.ui.mouse, {
        ...
        _createHandles: function () {
          ...
          for (n.length > s && (n.slice(s).remove(), (n = n.slice(0, s))), e = n.length; e < s; e++)
        ...
        _mouseCapture: function (e) {
          ...
          return (
            ...
            this.handles.each(function (e) {
              ...
              (r < n || (n === r && (e === l._lastChangedValue || l.values(e) === c.min))) &&
                ((n = r), (o = t(this)), (s = e));
            }),
            !1 !== this._start(e, s) &&
                  ...
                  "horizontal" === this.orientation
                    ...
                    : ((e = this.elementSize.height),
                      t.y -
                        ...
                        (this._clickOffset ? this._clickOffset.top : 0))) / e) && (t = 1),
            t < 0 && (t = 0),
        ...
        _uiHash: function (t, e, i) {
          ...
          return (
            this._hasMultipleValues() &&
              ((n.value = void 0 !== e ? e : this.values(t)), (n.values = i || this.values())),
            n
          );
        },
        ...
        _setOption: function (e, i) {
          ...
          switch (
            ...
            case "value":
              ...
              break;
            case "values":
              for (this._animateOff = !0, this._refreshValue(), n = o - 1; 0 <= n; n--)
                this._change(null, n);
              this._animateOff = !1;
              break;
            case "step":
                ...
                (i = ((l.values(n) - l._valueMin()) / (l._valueMax() - l._valueMin())) * 100),
                  ...
                  !0 === l.options.range &&
                    ("horizontal" === l.orientation
                      ? (0 === n &&
                          l.range.stop(1, 1)[c ? "animate" : "css"]({ left: i + "%" }, a.animate),
                        1 === n &&
                      ...
                      : (0 === n &&
                          l.range.stop(1, 1)[c ? "animate" : "css"]({ bottom: i + "%" }, a.animate),
                        1 === n &&
                          l.range[c ? "animate" : "css"](
                            { height: i - e + "%" },
                            { queue: !1, duration: a.animate },
    ...
    (v.prototype = {
      ...
      open: function (i) {
        ...
        if (!e.isOpen) {
          ...
          return (
            ...
            setTimeout(function () {
              e.content ? (e._addClassToMFP(f), e._setFocus()) : e.bgOverlay.addClass(f),
      ...
      parseEl: function (i) {
        var n,
          o = e.items[i];
        if (
          (o.tagName ? (o = { el: t(o) }) : ((n = o.type), (o = { data: o, src: o.src })), o.el)
        ) {
      ...
      addGroup: function (t, i) {
        ...
        (i.mainEl = t),
          i.items
            ...
            : ((i.isObj = !1),
              i.delegate ? t.off(o).on(o, i.delegate, n) : ((i.items = t), t.off(o).on(o, n)));
      },
    ...
    var $ = "iframe",
      H = function (t) {
        if (e.currTemplate[$]) {
          ...
          i.length &&
            (t || (i[0].src = "//about:blank"), e.isIE8 && i.css("display", t ? "block" : "none"));
        }
      };
    t.magnificPopup.registerModule($, {
      ...
      proto: {
        ...
        getIframe: function (i, n) {
          ...
          var r = {};
          return (
            s.srcAction && (r[s.srcAction] = o), e._parseMarkup(n, r, i), e.updateStatus("ready"), n
          );
        },
      },
    });
    ...
    ((e = (function () {
      ...
      (e.prototype.buildRows = function () {
        var t,
          ...
          a = this;
        if (
          ((n = document.createDocumentFragment()), (s = a.$slider.children()), a.options.rows > 1)
        ) {
          for (
          ...
          null !== e.$dots &&
            (e.$slides.not(e.$slideTrack.find(".slick-cloned")).each(function (i) {
              ...
              t(this).attr({
                ...
                -1 !== o &&
                  t(this).attr({ "aria-describedby": "slick-slide-control" + e.instanceUid + o });
            }),
            e.$dots
              .attr("role", "tablist")
              .find("li")
      ...
      (e.prototype.lazyLoad = function () {
        ...
        e(i),
          s.slideCount <= s.options.slidesToShow
            ...
            : 0 === s.currentSlide &&
              e(s.$slider.find(".slick-cloned").slice(-1 * s.options.slidesToShow));
      }),
